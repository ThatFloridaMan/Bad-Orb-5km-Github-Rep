...
class FD_WallGeneratorEntityClass : SCR_LineTerrainShaperGeneratorBaseEntityClass
{
}

class FD_WallGeneratorEntity : SCR_LineTerrainShaperGeneratorBaseEntity
{
	/*
		Middle Object
	*/
	...
	*/
	...
	protected ref FD_WallGroupContainer m_WallGroupContainer;
	...
	protected void Generate()
	{
		...
		if (!m_WallGroupContainer)
			m_WallGroupContainer = new FD_WallGroupContainer(m_aWallGroups, UseXAsForward, MiddleObject);
